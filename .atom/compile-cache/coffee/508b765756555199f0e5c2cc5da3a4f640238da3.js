(function() {
  ...
  ScrollKeepingCursor = (function(_super) {
    ...
    function ScrollKeepingCursor() {
      return ScrollKeepingCursor.__super__.constructor.apply(this, arguments);
    }
    ...
    ScrollKeepingCursor.prototype.scrollScreen = function(count) {
      ...
      this.previousFirstScreenRow = this.editor.getFirstVisibleScreenRow();
      destination = this.scrollDestination(count);
      this.editor.setScrollTop(destination);
      this.currentFirstScreenRow = this.editor.getFirstVisibleScreenRow();
      return destination;
    };
