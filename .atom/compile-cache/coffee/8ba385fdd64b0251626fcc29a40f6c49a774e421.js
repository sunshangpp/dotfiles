(function() {
  var $, SublimeTabBarView, SublimeTabView, SublimeTreeView, View, WorkspaceView, path, _, _ref,
  ...
  describe("tree-view:expand-directory-or-preview-file", function() {
    var treeView;
    treeView = null;
    beforeEach(function() {
      var fixturesPath, path1, workspaceElement;
      ...
      return runs(function() {
        ...
        return treeView = $(atom.workspace.getLeftPanels()[0].getItem()).view();
      });
    });
    describe("when a collapsed directory is selected", function() {
      return it("expands the directory", function() {
        var subdir1;
        ...
        return expect(subdir1).toHaveClass('expanded');
      });
    });
    describe("when an expanded directory is selected", function() {
      return it("keeps the directory expanded", function() {
        var subdir1;
        subdir1 = treeView.find('.directory:eq(1)');
        subdir1.click();
    ...
    return describe("when a file is selected", function() {
      return it("opens selected entry without loosing focus", function() {
        var treeViewPackage;
        ...
        atom.commands.dispatch(treeView.element, 'tree-view:expand-directory-or-preview-file');
        return expect(treeViewPackage.openSelectedEntry).toHaveBeenCalledWith(false);
      });
    });
  });
