    ...
    describe("the / keybinding", function() {
      ...
      describe("as a motion", function() {
        ...
        describe("repeating", function() {
          ...
          beforeEach(function() {
            keydown('/');
            editor.commandModeInputView.editor.setText('def');
            return editor.commandModeInputView.editor.trigger('core:confirm');
          });
      ...
      return describe("using search history", function() {
        ...
        it("allows searching history in the search field", function() {
          ...
          editor.commandModeInputView.editor.trigger('core:move-up');
          return expect(editor.commandModeInputView.editor.getText()).toEqual('def');
        });
        return it("resets the search field to empty when scrolling back", function() {
          ...
          expect(editor.commandModeInputView.editor.getText()).toEqual('abc');
          editor.commandModeInputView.editor.trigger('core:move-down');
          return expect(editor.commandModeInputView.editor.getText()).toEqual('');
        });
      });
    });
    describe("the * keybinding", function() {
