(function() {
  var CompositeDisposable, Disposable, Emitter, Motions, Operators, Point, Prefixes, Range, Scroll, TextObjects, Utils, VimState, settings, _, _ref, _ref1;
    ...
    VimState.prototype.destroy = function() {
      ...
      if (!this.destroyed) {
        ...
        if (this.editor.isAlive()) {
          ...
          this.editorElement.classList.remove("command-mode");
        }
        this.editor = null;
    ...
    VimState.prototype.setupCommandMode = function() {
      ...
      return this.registerOperationCommands({
        ...
        'scroll-half-screen-up': (function(_this) {
          return function() {
            return new Motions.ScrollHalfUpKeepCursor(_this.editor, _this);
          };
        })(this),
        'scroll-full-screen-up': (function(_this) {
          return function() {
            return new Motions.ScrollFullUpKeepCursor(_this.editor, _this);
          };
        })(this),
        'scroll-half-screen-down': (function(_this) {
          return function() {
            return new Motions.ScrollHalfDownKeepCursor(_this.editor, _this);
          };
        })(this),
        'scroll-full-screen-down': (function(_this) {
          return function() {
            return new Motions.ScrollFullDownKeepCursor(_this.editor, _this);
          };
        })(this),
