(function() {
  ...
  dir = function(andSubmodules) {
    var found, submodule, _ref1, _ref2;
  ...
  relativize = function(path) {
    ...
    return (_ref1 = (_ref2 = (_ref3 = getSubmodule(path)) != null ? _ref3.relativize(path) : void 0) != null ? _ref2 : (_ref4 = atom.project.getRepo()) != null ? _ref4.relativize(path) : void 0) != null ? _ref1 : path;
  };

  getSubmodule = function(path) {
    var _ref1, _ref2;
    if (path == null) {
      path = (_ref1 = atom.workspace.getActiveEditor()) != null ? _ref1.getPath() : void 0;
    }
    return (_ref2 = atom.project.getRepo()) != null ? _ref2.repo.submoduleForPath(path) : void 0;
  };

  getRepo = function() {
    var data, repo, _ref1;
    repo = GitRepository.open((_ref1 = atom.workspace.getActiveEditor()) != null ? _ref1.getPath() : void 0, {
